...
echo "Semantic V3 rich/Pose editor v0.3: contextual hair normalization and conservative text-only Pose repair."
echo "Conditional Pose reconstruction remains withheld from the editor."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_pose_editor_v03 "$@"
