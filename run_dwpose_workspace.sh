...
# Run the DWPose profiler using the self-contained /workspace environment created
# by build_workspace.sh, with all model/package caches kept off the root overlay.
