...
echo "Semantic V3 rich/Pose editor v0.7: primary-subject-only identity redaction with compact transient-hair preservation."
echo "Secondary/background people and depicted artwork remain scene content; v0.5 Pose conflict enforcement is unchanged."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_pose_editor_v07 "$@"
