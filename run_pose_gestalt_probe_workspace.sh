...
# The gestalt probe uses the same native FP8/vLLM environment as Analyze v2.1.
# Keep this separate from /workspace/qwen3/.venv, which owns the base
# Transformers/DWPose tooling and intentionally does not install vLLM.
...
cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.pose_gestalt_probe "$@"
