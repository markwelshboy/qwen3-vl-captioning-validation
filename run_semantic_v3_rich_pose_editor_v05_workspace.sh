...
echo "Semantic V3 rich/Pose editor v0.5: v0.4 conservative editing with Pose-language-complete orientation conflict enforcement."
echo "Conditional Pose reconstruction remains withheld from the editor."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_pose_editor_v05 "$@"
