...
EXPECTED_INPUT_SCHEMA = "caption-fact-sheet-0.2.12"
...
def main() -> int:
    ...
    if not input_dir.is_dir():
        print(f"Phase-4B.12 fact-sheet directory not found: {input_dir}", file=sys.stderr)
        return 2
    ...
    index = {
        ...
        "invariants": {
            "no_model_calls": True,
            "phase4b12_is_input_not_recomputed": True,
