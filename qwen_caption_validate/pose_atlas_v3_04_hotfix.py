...
atlas review uses the current v0.5 profile semantics without rewriting the
large diagnostic renderer.
"""

from . import pose_atlas_v3_04 as v04
from . import sam3d_relational_pose_profile_05 as relprof05


v04.v03._resolve_mesh = v04.v03.v02._resolve_mesh
v04.relprof = relprof05

_original_make_card = v04._make_card
_original_html_index = v04._html_index


def _make_card_v05(*args, **kwargs):
...
def _html_index_v05(records):
    text = _original_html_index(records)
    return text.replace(
        "Raised-open-hand geometry is only a waving candidate and requires VLM confirmation.",
        "Open/closed hand shape and wrist height remain geometry primitives; action semantics are reserved for Fusion/Caption. Projected posture uses competing standing/crouching/squatting/sitting/reclined geometry scores.",
    )


v04._make_card = _make_card_v05
v04._html_index = _html_index_v05
