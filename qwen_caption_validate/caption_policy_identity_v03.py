...
DEFAULT_INPUT_SUBDIR = Path("semantic-v3") / "caption-fact-sheet-v0.2.4"
DEFAULT_OUTPUT_SUBDIR = Path("semantic-v3") / "caption-fact-sheet-v0.3"
EXPECTED_INPUT_SCHEMA = "caption-fact-sheet-0.2.4"
...
def main() -> int:
    ...
    if not input_dir.is_dir():
        print(f"Phase-4B.4 fact-sheet directory not found: {input_dir}", file=sys.stderr)
        return 2
    ...
    index = {
        ...
        "invariants": {
            "no_model_calls": True,
            "phase4b4_is_input_not_recomputed": True,
