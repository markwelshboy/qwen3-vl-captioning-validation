...
from .caption_projection_154 import build_caption_projection
...
def main() -> int:
    ...
    output_dir = (args.output_dir or (run_dir / "projection-v1.5.4" / slug)).expanduser().resolve()
    ...
    index = {
        "schema_version": "caption-projection-1.5.4-run",
        "run_dir": str(run_dir),
    ...
    index_path = output_dir / "projection_154.index.json"
    _write(index_path, index)
    print(f"Projection 1.5.4 output: {output_dir}")
    print(
