...
DEFAULT_INPUT_SUBDIR = Path("semantic-v3") / "caption-fact-sheet-v0.2.10"
DEFAULT_OUTPUT_SUBDIR = Path("semantic-v3") / "caption-fact-sheet-v0.3"
EXPECTED_INPUT_SCHEMA = "caption-fact-sheet-0.2.10"
...
def main() -> int:
    ...
    if not input_dir.is_dir():
        print(f"Phase-4B.10 fact-sheet directory not found: {input_dir}", file=sys.stderr)
        return 2
    ...
    index = {
        ...
        "invariants": {
            ...
            "withheld_asymmetric_ground_contact_is_not_reintroduced": True,
            "support_geometry_is_preserved_for_audit": True,
