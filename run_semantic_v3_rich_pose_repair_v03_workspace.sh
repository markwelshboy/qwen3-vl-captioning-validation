...
echo "Semantic V3 rich/Pose repair v0.3: fail-only repair using editor v0.5 audit plus calibrated laterality/grammar guards."
echo "Governed fist laterality authorizes the same-side hand; no broader limb-chain inference is added."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_pose_repair_v03 "$@"
