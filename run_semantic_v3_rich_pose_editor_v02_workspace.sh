...
echo "Semantic V3 rich/Pose editor v0.2: conservative text-only edit with explicit redaction directives."
echo "Conditional Pose reconstruction remains withheld from the editor."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_pose_editor_v02 "$@"
