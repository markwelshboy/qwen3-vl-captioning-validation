...
echo "Semantic V3 compact renderer v0.2: hard word budgets plus trigger/coreference binding."
echo "Frozen Semantic V3 editor/repair/Pose artifacts are read-only inputs; no image inference occurs."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_compact_renderer_v02 "$@"
