...
echo "Semantic V3 compact renderer v0.3: v0.2 rendering policy with a safer 320-token default ceiling."
echo "No semantic-policy change; this version prevents medium captions from being silently truncated before deterministic budgeting."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_compact_renderer_v03 "$@"
