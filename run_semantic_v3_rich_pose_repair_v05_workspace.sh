...
echo "Semantic V3 rich/Pose repair v0.5: fail-only repair using editor v0.7 primary-subject audit."
echo "Compound protected phrases are forbidden verbatim in repaired output; fist->hand and local grammar guards remain narrow."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_pose_repair_v05 "$@"
