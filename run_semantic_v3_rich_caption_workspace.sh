...
echo "Semantic V3 rich baseline: one image-conditioned VLM call -> dense natural-language visual draft."
echo "Pose v0.16 and scene/Gestalt governance are downstream; this pass preserves visual richness."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_caption "$@"
