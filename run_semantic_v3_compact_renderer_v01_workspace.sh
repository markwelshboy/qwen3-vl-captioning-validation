...
echo "Semantic V3 compact renderer v0.1: frozen semantic captions -> trigger-bound compact/medium training captions."
echo "The renderer is text-only. It compresses, preserves governed Pose, and may repeat the trigger to clarify ownership/coreference."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_compact_renderer_v01 "$@"
