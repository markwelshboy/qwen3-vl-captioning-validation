...
echo "Semantic V3 rich/Pose repair v0.7: v0.6 repair policy plus narrow primary-subject apparent-age proxy validation."
echo "Fine lines, crow's feet, and facial lines are repairable only for the primary subject; skin texture and scene-content people remain untouched."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_pose_repair_v07 "$@"
