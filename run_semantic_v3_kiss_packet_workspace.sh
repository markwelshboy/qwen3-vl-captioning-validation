...
echo "Semantic V3 KISS reset: Ask once, minimally. Storage bins are not questions."
echo "One image VLM call -> sparse semantic packet. No Analyze/Gestalt LLM calls."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_kiss_packet "$@"
