...
echo "Semantic V3 compact renderer finisher v0.1: conditionally shave/fix only renderer v0.2 hard-gate misses."
echo "Frozen semantic captions and successful renderer outputs are preserved; no image inference occurs."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_compact_renderer_finish_v01 "$@"
