...
echo "Semantic V3 rich/Pose editor v0.6: blind-calibrated primary-subject hair policy with v0.5 Pose conflict enforcement."
echo "Depicted figures inside tattoos/artwork remain scene content; conditional Pose reconstruction remains withheld."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_pose_editor_v06 "$@"
