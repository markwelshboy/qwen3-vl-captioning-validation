...
echo "Semantic V3 rich/Pose editor: rich VLM prose + governed caption-ready Pose -> conservative text-only edit."
echo "The editor never sees the image and conditional Pose reconstruction hints are withheld."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_pose_editor "$@"
