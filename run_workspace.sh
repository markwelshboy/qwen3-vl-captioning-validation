...
# Run the validator using the self-contained /workspace environment created by
# build_workspace.sh. This deliberately bypasses /opt/venv and any hashed shell
# command that might point at Fizgig's Python environment.
