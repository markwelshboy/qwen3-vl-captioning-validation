...
Options:
  ...
  --profile-output PATH Profile v0.4 output directory
...
if [[ -z "${PROFILE_OUTPUT}" ]]; then PROFILE_OUTPUT="${SAM3D_DIR}/relational-pose-profile-v0.4"; fi
...
echo "=== 1/2 Relational pose profile v0.4 ==="
QWEN_WORKSPACE_ROOT="${ROOT}" bash "${REPO_ROOT}/run_sam3d_relational_pose_profile_04_workspace.sh" \
  "${SAM3D_DIR}" \
