...
echo "Semantic V3 rich caption v0.2: dense image-conditioned draft with protected persistent hair identity and preserved transient hair state."
echo "Pose v0.16 remains downstream and independent."

cd "$REPO_ROOT"
exec "$PY" -m qwen_caption_validate.semantic_v3_rich_caption_v02 "$@"
